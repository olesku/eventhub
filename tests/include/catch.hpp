...
struct is_unique<T0, T1, Rest...> : std::integral_constant<bool,
...
#define INTERNAL_CATCH_TEMPLATE_PRODUCT_TEST_CASE2(TestName, TestFuncName, Name, Tags, TmplTypes, TypesList)                                                                                                                            \
  ...
  static int INTERNAL_CATCH_UNIQUE_NAME(globalRegistrar) = []() {                                                                                                                                                                       \
    using TestInit = combine<INTERNAL_CATCH_REMOVE_PARENS(TmplTypes)>::with_types<INTERNAL_CATCH_MAKE_TYPE_LISTS_FROM_TYPES(TypesList)>::into<TestName>::type;                                                                          \
    TestInit();                                                                                                                                                                                                                         \
    return 0;                                                                                                                                                                                                                           \
  }();                                                                                                                                                                                                                                  \
  }                                                                                                                                                                                                                                     \
...
#define INTERNAL_CATCH_TEMPLATE_PRODUCT_TEST_CASE_METHOD_2(TestNameClass, TestName, ClassName, Name, Tags, TmplTypes, TypesList)                                                                                                  \
  ...
  static int INTERNAL_CATCH_UNIQUE_NAME(globalRegistrar) = []() {                                                                                                                                                                 \
    using TestInit = combine<INTERNAL_CATCH_REMOVE_PARENS(TmplTypes)>::with_types<INTERNAL_CATCH_MAKE_TYPE_LISTS_FROM_TYPES(TypesList)>::into<TestNameClass>::type;                                                               \
    TestInit();                                                                                                                                                                                                                   \
    return 0;                                                                                                                                                                                                                     \
  }();                                                                                                                                                                                                                            \
  }                                                                                                                                                                                                                               \
