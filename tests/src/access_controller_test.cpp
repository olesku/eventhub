...
TEST_CASE("Test authorization", "[access_controller]") {
  GIVEN("A valid test token") {
    std::string token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjIyMTQ2OTQ5MjMsInN1YiI6Im9sZS5za3Vkc3Zpa0BnbWFpbC5jb20iLCJ3cml0ZSI6WyIvdGVzdDEvIyIsIi90ZXN0Mi8jIiwiL3Rlc3QzLyMiXSwicmVhZCI6WyIvdGVzdDEvIyIsIi90ZXN0Mi8jIiwiL3Rlc3QzLyMiXSwiY3JlYXRlVG9rZW4iOlsiL3Rlc3QxIiwiL3Rlc3QyIiwiL3Rlc3QzIl19.YbMcgpPukCSWdSOmFypqxAlV2VszMGgHlkMS49mgGnA";
    
    AccessController acs;
    bool token_loaded = acs.loadToken(token, "eventhub_secret");
