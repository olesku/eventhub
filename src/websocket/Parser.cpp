...
static int parserOnDataPayload(void* userData, const char* buff, unsigned int len) {
  auto obj = static_cast<Parser*>(userData);
...
static int parserOnControlPayload(void* userData, const char* buff, unsigned int len) {
  auto obj = static_cast<Parser*>(userData);
...
void Parser::appendDataPayload(const char* data, unsigned int len) {
...
void Parser::appendControlPayload(const char* data, unsigned int len) {
...
void Parser::parse(char* buf, unsigned int len) {
