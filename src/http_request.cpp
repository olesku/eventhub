...
/**
  ...
  **/
HTTPRequest::request_state HTTPRequest::parse(const char* data, int len) {
  int pret;
...
/**
  ...
  **/
const string HTTPRequest::get_header(string header) {
  str_tolower(header);
...
/**
  ...
  **/
const string HTTPRequest::get_query_string(string param) {
  str_tolower(param);
...
/**
  ...
  **/
size_t HTTPRequest::num_query_string() {
  return _qsmap.size();
}

const string& HTTPRequest::get_post_data() {
  return _post_data;
}

const string& HTTPRequest::get_error_message() {
